...
public final class Constants {
  ...
  public static final class FuelConstants {
    ...
    public static final int INTAKE_SHOOTER_MOTOR_ID = 15;
    ...
    public static final double INTAKING_FEEDER_VOLTAGE = 7.5;
    public static final double INTAKING_INTAKE_VOLTAGE = -4.5;
    public static final double LAUNCHING_FEEDER_VOLTAGE = 4;
    public static final double LAUNCHING_LAUNCHER_VOLTAGE = -6.8;
